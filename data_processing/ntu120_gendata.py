...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path',
                        default='data/read_ntu120/raw_txt')
    parser.add_argument(
        '--ignored_sample_path',
        default=
        'data_processing/nturgbd120_samples_with_missing_skeletons.txt'
    )
    parser.add_argument('--out_folder', default='data/NTU-RGB-D-120')
